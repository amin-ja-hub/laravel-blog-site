        ...
        <div class="container">
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                ...
                <div class="blog-title-wrap">
                    ...
                    <a class="author" href="single-layout-one.html#">
                        <img src="{{ asset('storage/' . $post->image) }}" alt="" class="rounded-circle" />
                        <span class="">{{ $post->user->name}}</span>
                    </a>
                    <a class="date" href="single-layout-one.html#">
                        <span>{{ $post->created_at->format('d M, Y') }}</span>
                    </a>
                    </div>
                    <ul class="category-tag-list mb-0">
                    <li class="category-tag-name">
                        <a href="single-layout-one.html#">{{$post->category->name}}</a>
                    </li>
                    </ul>
                ...
                <div class="tags-wrap">
                    ...
                    <ul class="sidebar-list tags-list">
                        <p>Tags:</p>
                        @foreach ($tags as $tag)
                            <li><a href="{{ route('posts.index', ['tag' => $tag]) }}">{{ $tag }}</a></li>
                        @endforeach
                    </ul>
                    </div>
                    ...
                    <p>Share Now:</p>
                    <ul class="share-list">
                        <li><a href="single-layout-one.html#"><img src="https://demo.codevibrant.com/html/kavya/assets/images/facebook.png" alt=""></a></li>
                        <li><a href="single-layout-one.html#"><img src="https://demo.codevibrant.com/html/kavya/assets/images/twitter.png" alt=""></a></li>
                        <li><a href="single-layout-one.html#"><img src="https://demo.codevibrant.com/html/kavya/assets/images/pinterest.png" alt=""></a></li>
                        <li><a href="single-layout-one.html#"><img src="https://demo.codevibrant.com/html/kavya/assets/images/messenger.png" alt=""></a></li>
                    </ul>
                    </div>
                </div>
