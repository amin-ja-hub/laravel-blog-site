    ...
    <header>
        ...
        <div class="container">
            ...
            <ul class="nav-menu ml-auto mr-auto" id="nav-menu-toggle">
                ...
                <li class="nav-item"><a href="index.html#" class="nav-link">Categories <span class="arrow-icon"> <span
                        class="left-bar"></span>
                ...
                <li class="nav-item drop-arrow"><a href="index.html#" class="nav-link">Pages <span class="arrow-icon"> <span
                        class="left-bar"></span>
                ...
                <ul class="drop-menu">
                    ...
                    <li class="drop-menu-item"><a href="https://demo.codevibrant.com/html/kavya/index5.html">Home Page RTL</a></li>
                ...
                <li class="nav-item drop-arrow"><a href="index.html#" class="nav-link">Layout <span class="arrow-icon"> <span
                        class="left-bar"></span>
                    <span class="right-bar"></span></span></a>
                <ul class="drop-menu">
